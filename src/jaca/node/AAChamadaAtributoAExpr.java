...
public final class AAChamadaAtributoAExpr extends PAExpr
{
    private TId _id_;
    private PAAtributo _aAtributo_;

    public AAChamadaAtributoAExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAChamadaAtributoAExpr(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAChamadaAtributoAExpr(this);
    }
