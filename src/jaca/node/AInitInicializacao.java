...
public final class AInitInicializacao extends PInicializacao
{
    private TId _id_;
    private TAtribuicao _atribuicao_;
    private PExpr _expr_;

    public AInitInicializacao()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAInitInicializacao(this);
    }
