...
public final class AChamadaAtributoExprNivelOito extends PExprNivelOito
{
    private TId _id_;
    ...
    public AChamadaAtributoExprNivelOito()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaAtributoExprNivelOito(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamadaAtributoExprNivelOito(this);
    }
