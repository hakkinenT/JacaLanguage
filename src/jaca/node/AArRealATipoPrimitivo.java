...
public final class AArRealATipoPrimitivo extends PATipoPrimitivo
{
    private TTipoReal _tipoReal_;

    public AArRealATipoPrimitivo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArRealATipoPrimitivo(
    ...
    {
        ((Analysis) sw).caseAArRealATipoPrimitivo(this);
    }
