...
public final class AArTipoPrimitivoATipo extends PATipo
{
    private PATipoPrimitivo _aTipoPrimitivo_;

    public AArTipoPrimitivoATipo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArTipoPrimitivoATipo(
    ...
    {
        ((Analysis) sw).caseAArTipoPrimitivoATipo(this);
    }
