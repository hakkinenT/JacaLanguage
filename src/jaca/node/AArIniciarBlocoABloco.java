...
public final class AArIniciarBlocoABloco extends PABloco
{
    ...
    public Object clone()
    {
        return new AArIniciarBlocoABloco(
    ...
    {
        ((Analysis) sw).caseAArIniciarBlocoABloco(this);
    }
