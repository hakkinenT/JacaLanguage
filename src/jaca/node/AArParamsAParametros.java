...
public final class AArParamsAParametros extends PAParametros
{
    ...
    public Object clone()
    {
        return new AArParamsAParametros(
    ...
    {
        ((Analysis) sw).caseAArParamsAParametros(this);
    }
