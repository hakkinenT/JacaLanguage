...
public final class AArInitAInicializacao extends PAInicializacao
{
    private TId _id_;
    private PAExpr _aExpr_;

    public AArInitAInicializacao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArInitAInicializacao(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAArInitAInicializacao(this);
    }
