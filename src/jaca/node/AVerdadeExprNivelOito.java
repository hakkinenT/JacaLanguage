...
public final class AVerdadeExprNivelOito extends PExprNivelOito
{
    private TVerdade _verdade_;

    public AVerdadeExprNivelOito()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVerdadeExprNivelOito(
    ...
    {
        ((Analysis) sw).caseAVerdadeExprNivelOito(this);
    }
