...
public final class AArDecObjAAtributos extends PAAtributos
{
    private PADecObj _aDecObj_;

    public AArDecObjAAtributos()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArDecObjAAtributos(
    ...
    {
        ((Analysis) sw).caseAArDecObjAAtributos(this);
    }
