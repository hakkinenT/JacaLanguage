...
public final class ANRealExprNivelOito extends PExprNivelOito
{
    private TNumeroReal _numeroReal_;

    public ANRealExprNivelOito()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANRealExprNivelOito(
    ...
    {
        ((Analysis) sw).caseANRealExprNivelOito(this);
    }
