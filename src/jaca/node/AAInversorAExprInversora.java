...
public final class AAInversorAExprInversora extends PAExprInversora
{
    private PAExpr _aExpr_;

    public AAInversorAExprInversora()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAInversorAExprInversora(
    ...
    {
        ((Analysis) sw).caseAAInversorAExprInversora(this);
    }
