...
public final class AARelacoesAListaRelacoes extends PAListaRelacoes
{
    private PARelacao _aRelacao_;

    public AARelacoesAListaRelacoes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AARelacoesAListaRelacoes(
    ...
    {
        ((Analysis) sw).caseAARelacoesAListaRelacoes(this);
    }
