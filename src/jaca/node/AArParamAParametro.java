...
public final class AArParamAParametro extends PAParametro
{
    private PATipo _aTipo_;
    private TId _id_;

    public AArParamAParametro()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAArParamAParametro(this);
    }
