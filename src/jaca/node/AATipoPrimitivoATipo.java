...
public final class AATipoPrimitivoATipo extends PATipo
{
    private PATipoPrimitivo _aTipoPrimitivo_;

    public AATipoPrimitivoATipo()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AATipoPrimitivoATipo(
    ...
    {
        ((Analysis) sw).caseAATipoPrimitivoATipo(this);
    }
