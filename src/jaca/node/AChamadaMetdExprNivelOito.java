...
public final class AChamadaMetdExprNivelOito extends PExprNivelOito
{
    private TId _id_;
    ...
    public AChamadaMetdExprNivelOito()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaMetdExprNivelOito(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamadaMetdExprNivelOito(this);
    }
