...
public final class AAExprAExprInversora extends PAExprInversora
{
    private PAExpr _aExpr_;

    public AAExprAExprInversora()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAExprAExprInversora(
    ...
    {
        ((Analysis) sw).caseAAExprAExprInversora(this);
    }
