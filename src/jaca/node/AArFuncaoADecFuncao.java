...
public final class AArFuncaoADecFuncao extends PADecFuncao
{
    private PATipo _aTipo_;
    private TId _id_;
    private PAParametros _aParametros_;

    public AArFuncaoADecFuncao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArFuncaoADecFuncao(
    ...
    {
        ((Analysis) sw).caseAArFuncaoADecFuncao(this);
    }
