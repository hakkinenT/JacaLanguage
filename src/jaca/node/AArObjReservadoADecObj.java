...
public final class AArObjReservadoADecObj extends PADecObj
{
    private TClasseReservada _classeReservada_;
    private TId _id_;

    public AArObjReservadoADecObj()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArObjReservadoADecObj(
    ...
    {
        ((Analysis) sw).caseAArObjReservadoADecObj(this);
    }
