...
public final class AArEnquantoAComando extends PAComando
{
    private PAExprIni _aExprIni_;
    private PAComando _aComando_;

    public AArEnquantoAComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArEnquantoAComando(
    ...
    {
        ((Analysis) sw).caseAArEnquantoAComando(this);
    }
