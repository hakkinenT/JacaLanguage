...
public final class AArDefiniADefClasse extends PADefClasse
{
    ...
    public Object clone()
    {
        return new AArDefiniADefClasse(
    ...
    {
        ((Analysis) sw).caseAArDefiniADefClasse(this);
    }
