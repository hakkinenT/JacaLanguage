...
public final class AArProcedCompletoADecProcedimento extends PADecProcedimento
{
    private TId _id_;
    private PAParametros _aParametros_;
    private PAComando _aComando_;

    public AArProcedCompletoADecProcedimento()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArProcedCompletoADecProcedimento(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAArProcedCompletoADecProcedimento(this);
    }
